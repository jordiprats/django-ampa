...
urlpatterns = [
    ...
    path('classes/<classe_id>/mailing/new', views.editar_mailing_classe, name='enviar.email'),
    path('classes/<classe_id>/mailing/<mailing_id>', views.editar_mailing_classe, name='show.email'),
