...
urlpatterns = [
    ...
    path('cursos/<curs_id>/cessio_dades', views.enviar_cessio_dades_curs, name='curs.cessio.dades'),
    ...
    path('classes/<classe_id>/mailing/new', views.edit_mailing_classe, name='nou.classe.mailing'),
    path('classes/<classe_id>/mailing/<mailing_id>', views.edit_mailing_classe, name='edit.classe.mailing'),
